...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
	    ['Credits'],
		['JakeTheAnimator',			'jaketheanimator',		"Creator of this Mod",					'https://twitter.com/jake_animator',		0xFF6475F3],
		['Jacknjellify',		'jacknjellify',		'Creator of Coiny and the BFDI series',					'https://twitter.com/jacknjellify',	0xFFFFDD33],
		[''],
		['Psych Engine Team'],
